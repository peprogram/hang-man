...
void hangman::check (char CH, char TEXT[50], int &WRONG, int &SCORE)
{
	...
	case 1:
	  ...
	  do
		...
		case 1:
		  ...
		  outtextxy (85, 350, "GOOD LUCK & HAVE FUN PLAYING HANGMAN!!");
		  setcolor (LIGHTBLUE);
		  outtextxy (25, 150, "Guess the phrase with the help of the hint given.");
		  outtextxy (25, 190, "Each - depicts an alphabet of the phrase to be guessed.");
		  outtextxy (25, 230, "You can have a maximum of seven wrong guesses only,");
		  outtextxy (25, 250, "that is, before the whole body of the man appears.");
		  outtextxy (25, 290, "Guess the right phrase to advance to the next level.");
		  getch ();
		  break;
		case 2:
